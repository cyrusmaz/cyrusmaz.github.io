...
backtester_path="/home/zadegan/backtester_core.py"

backtest_results_directory="/home/zadegan/backtest/"
heatmap_df_directory = "/home/zadegan/heatmap"

heatmap_plot_directory_container = "/home/zadegan/heatmap_plot/"

price_csv_directory="/home/zadegan/price/"

sf_sequences_directory="/home/zadegan/sf_sequences_directory/"

growth_directory="/home/zadegan/growth/"
...
def backtest_generator(fast_start,fast_fin,slow_start,slow_fin,risk_per_trade,max_leverage,start_index,end_index,price_file_name):
    ...
    for combo in filtered_combos:
        ...
        if not os.path.isfile(backtest_file_path):
            ...
            terminal_command="/home/zadegan/backtest_env/bin/python3 "+ backtester_path + " {} {} {} {} {} {} {}".format(
                        fast_period,
                        slow_period,
                        risk_per_trade,
                        max_leverage,
